...
class Review(TypedDict):
    key_themes: Annotated[list[str],
                          "write down all key themes discuss in review"]
    summary: Annotated[str, "A breaf summary of review"]
    sentiment: Annotated[str,
                         "Return sentiment of review either negative, positive or natural"]
